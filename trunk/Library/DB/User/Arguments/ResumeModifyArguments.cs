...
{
	public class ResumeModifyArguments : DBArguments
	{
		public int UserNo
		{
		...
		{
			get { return Convert.ToDateTime(GetValue("RegistryTime", DateTime.MinValue)); }
			set { SetValue("RegistryTime", value); }
		}

		public byte Status
		{
			get { return Convert.ToByte(GetValue("Status", 0)); }
