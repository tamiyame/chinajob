...
namespace Com.Library.DB.Company
{
    public class CompanyDetailModify : DBDataReader<DataEntity, DataEntity>
    {
        ...
        protected override void ParameterInitialize()
        {
            ...
            AddParameter("KRName", SqlDbType.NVarChar, 200, SqlDataInOut.Input);
            AddParameter("CNName", SqlDbType.NVarChar, 200, SqlDataInOut.Input);
            AddParameter("ENGName", SqlDbType.NVarChar, 200, SqlDataInOut.Input);
            AddParameter("CompanyImage", SqlDbType.VarChar, 200, SqlDataInOut.Input);
            AddParameter("PermitNo", SqlDbType.NVarChar, 200, SqlDataInOut.Input);
            AddParameter("PermitImage", SqlDbType.VarChar, 200, SqlDataInOut.Input);
            AddParameter("Email", SqlDbType.NVarChar, 200, SqlDataInOut.Input);
            AddParameter("BusinessCategoryNo", SqlDbType.Int, 4, SqlDataInOut.Input);
            AddParameter("BusinessCategoryEtc", SqlDbType.NVarChar, 200, SqlDataInOut.Input);
            AddParameter("PresidentName", SqlDbType.NVarChar, 200, SqlDataInOut.Input);
            AddParameter("CapitalType", SqlDbType.TinyInt, 1, SqlDataInOut.Input);
            AddParameter("FoundYear", SqlDbType.NVarChar, 20, SqlDataInOut.Input);
            ...
            AddParameter("RecruiterName", SqlDbType.NVarChar, 200, SqlDataInOut.Input);
            AddParameter("PhoneNo", SqlDbType.VarChar, 200, SqlDataInOut.Input);
            AddParameter("FaxNo", SqlDbType.VarChar, 200, SqlDataInOut.Input);
            ...
            AddParameter("HomepageURL", SqlDbType.VarChar, 200, SqlDataInOut.Input);
        }
    }
}