...
namespace Com.Library.DB.Company
{
    public class CompanyDetailGetInfo : DBDataReader<DataEntity, CompanyDetailEntity>
    {
        ...
        protected override void ParameterInitialize()
        {
            ...
            AddParameter("BusinessCategoryEtc", SqlDbType.NVarChar, 200, SqlDataInOut.Output);
            AddParameter("KRName", SqlDbType.NVarChar, 200, SqlDataInOut.Output);
            AddParameter("CNName", SqlDbType.NVarChar, 200, SqlDataInOut.Output);
            AddParameter("ENGName", SqlDbType.NVarChar, 200, SqlDataInOut.Output);
            AddParameter("CompanyImage", SqlDbType.VarChar, 200, SqlDataInOut.Output);
            AddParameter("PermitNo", SqlDbType.NVarChar, 200, SqlDataInOut.InputOutput);
            AddParameter("Email", SqlDbType.NVarChar, 200, SqlDataInOut.InputOutput);
            AddParameter("PresidentName", SqlDbType.NVarChar, 200, SqlDataInOut.Output);
            AddParameter("CapitalType", SqlDbType.TinyInt, 1, SqlDataInOut.Output);
            AddParameter("FoundYear", SqlDbType.NVarChar, 20, SqlDataInOut.Output);
            ...
            AddParameter("RecruiterName", SqlDbType.NVarChar, 200, SqlDataInOut.Output);
            AddParameter("PhoneNo", SqlDbType.VarChar, 200, SqlDataInOut.Output);
            AddParameter("FaxNo", SqlDbType.VarChar, 200, SqlDataInOut.Output);
