<%@ Page Language="C#" MasterPageFile="~/Backoffice/WebMaster/SettingMaster.master" AutoEventWireup="true" CodeFile="Category2.aspx.cs" Inherits="Backoffice_Setting_Category2" %>
...
<style>
 ...
 .category td.col1{width:120px;}
 .category td.col2{width:120px;}
 .category td.col3{width:120px;}
 .category td.col4{width:50px;}
 .category td.col5{width:50px;}
...
<div style="overflow:hidden;">
    ...
    <div class="setting" style="float:right;">
        ...
        <div style="border:solid 1px #dddddd;height:250px;overflow-x: hidden; overflow-y: scroll;">
