...
public partial class KR_Operation_board_modify : ArticleModifyPage
{
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        if (this.IsPostBack)
        {
            ...
            Response.Write("<script language='javascript'> location.href='" + PageMove("board_list.aspx") + "'</script>");
        }
    }
}
