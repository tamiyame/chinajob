...
/// </summary>
public class KR_User_human_regist_detail : SitePage
{
	...
	public KR_User_human_regist_detail()
	{
		//
	...
	protected override void OnLoad(EventArgs e)
	{
		...
		if (this.IsPostBack)
		{
			...
			if (CountryCode == TranslateHelper.ContryCode.CN)
			{
				education_period_start = new string[] { DateTime.Now.ToString() };
				education_period_end = new string[] { DateTime.Now.ToString() };
				education_state = new string[] { "1" };
				education_national = new string[] { "" };
			}
			if (CountryCode == TranslateHelper.ContryCode.EN)
			{
				education_state = new string[] { "1" };
