...
{
    public class RecruitModifyArguments : DBArguments
    {
        ...
        {
            get { return Convert.ToInt32(GetValue("RecruitCount", string.Empty)); }
        ...
        {
            get { return Convert.ToDateTime(GetValue("RecruitDate", DateTime.MinValue )); }
