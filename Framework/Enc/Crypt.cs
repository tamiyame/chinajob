...
namespace Com.Library.Util
{
    ...
    {
        // 암호화 키
        private const string desKey = "sweetbox"; // 
        ...
        public static string MD5HashCrypt(string val)
        {
            ...
            Byte[] bytes = md5.ComputeHash(Encoding.ASCII.GetBytes(val));
        ...
        public static string DESEncrypt(string inStr)
        {
            ...
            d1 = DateTime.Parse("1970-01-01 09:00:00");
            d2 = DateTime.Now;
            d3 = d2 - d1;


            inStr = inStr + "/" + Convert.ToInt32(d3.TotalSeconds);
        ...
        public static string UTF8Decoding(string Value)
        {
            UTF8Encoding u8e = new UTF8Encoding();
