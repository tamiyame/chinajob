<%@ Page Language="C#" MasterPageFile="~/KR/WebMaster/OperationMaster.master" AutoEventWireup="true" CodeFile="board_detail.aspx.cs" Inherits="KR_Operation_board_detail" %>
...
<div class="title">
                        ...
                        <div class="contents">
                            ...
                            <%if (this.WebCookies.UserNo == ArticleInfo.UserNo){ %>
                                <div class="tool-left">
                                    <a href="<%=PageMove("board_modify.aspx")%>&ArticleNo=<%=ArticleNo %>" class="icon icon-board-modify"></a>
                                    <a href="javascript:;" class="icon icon-board-delete"  onclick="if ( confirm('정말로 삭제하시겠습니까?') ) { location.href='<%=PageMove("board_remove.aspx")%>&ArticleNo=<%=ArticleNo %>' } return false;"></a>
                                </div>
                            <% } %>
                                <div class="tool-right">
                                    <a href="<%=PageMove("board_list.aspx")%>" class="icon icon-board-list"></a>
                                </div>
                            </div>
                            <!--
