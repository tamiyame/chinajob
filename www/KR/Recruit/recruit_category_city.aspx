...
<%for (int i = 0; i < CategoryList.Count; i++) { %>   
                                        <li class="categoryItem <%= i % 3 == 0 ? "" : "sideline"%>">
                                            ...
                                            <span class="category1"><%=CategoryList[i].CategoryKRName %><span class="icon icon-board-icon-next" onclick="recruit_search.aspx?CityCategoryNo=<%=CategoryList[i].CategoryNo%>"></span></span>
                                            <ul class="category2">
<%
    ...
    foreach (SubCategoryEntity item in lstSubCategory)
    {
        ...
        {
%>
                                                <li><a href="recruit_search.aspx?AreaCategoryNo=<%=item.SubCategoryNo %>"><%=item.SubCategoryKRName %></a><!--(<span class="number">0</span>)--></li>
<%     } 
    }
%>
                                            </ul>  
