<%@ Page Language="C#" MasterPageFile="~/KR/WebMaster/RecruitMaster.master" AutoEventWireup="true" CodeFile="recruit_detail.aspx.cs" Inherits="KR_Recruit_recruit_detail"%>
                                        ...
                                        <td class="col1">
                                            <table class="company-detail">
                                                <tr>
                                                    ...
                                                    <%=GetEtcValue( GetSubCategoryName(RecruitInfo.Category2No),RecruitInfo.CategoryEtcValue) %>
                                                    </td>
                                                </tr>                                            
                                                <tr>
                                        ...
                                        <td class="col2">
                                            <table class="company-detail">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-2">
                                                    <%=GetEtcValue(GetCategoryName(RecruitInfo.Major), RecruitInfo.MajorEtcValue)%>
                                                    </td>
                                                </tr>                         
                                                <tr>
