<%@ Page Language="C#" MasterPageFile="~/KR/WebMaster/RecruitMaster.master" AutoEventWireup="true" CodeFile="recruit_regist_eng.aspx.cs" Inherits="KR_Company_recruit_regist_eng"%>
					...
					<td class="input">
						<table>
							<tr>
								...
								<td>
									<input id="major_direct" type="text" class="w2 hide" name="major_direct" maxlength="20" value="<%=RecruitInfo.MajorEtcValue %>"/>
								</td>															
							</tr>
						</table>
					</td>
					...
					<td class="input">
						<table>
							<tr>
								...
								<td>
									<input type="text" name="etc_lang" class="w2" maxlength="20" value="<%=RecruitInfo.ETCLanguageName%>"/>
