<%@ Page Language="C#" MasterPageFile="~/KR/WebMaster/SiteMaster.master" AutoEventWireup="true" CodeFile="human_modify.aspx.cs" Inherits="KR_User_human_modify" Title="제목 없음" %>
				    ...
				    <table class="join-table">
				        <tr>
				            ...
				            <td>
				                <table>
				                    <tr>
				                        <td><img class="picture" width="104px" height="138px" src="<%=UserInfo.ImageUrl %>" /></td>
				                    </tr>
				                    <tr>
				        ...
				        <tr>
				            ...
				            <td>
				                <table class="name">
				                    <tr>
				                        <td>국문</td><td><input type="text" name="KRName" value="<%=UserInfo.KRName %>" maxlength="30"/></td>
				                        <td rowspan="3" class="desc">
				                            주민등록증에 등록된 정규적인 성명을 입력하는것을 추천하며,<br />
				                            국문,중문,영문 중 반드시 하나 이상 기입하셔야 합니다.
				                        </td>
				                    </tr>
				                    <tr><td>중문</td><td><input type="text" name="CNName"  value="<%=UserInfo.CNName %>" maxlength="30"/></td></tr>
				                    <tr><td>영문</td><td><input type="text" name="ENGName" value="<%=UserInfo.ENGName %>"  maxlength="30"/></td></tr>
				                </table>
				            </td>
				        </tr>
				        <tr>
				            ...
				            <td>
				                <table>
				                    <tr>
				                        <td>
				                            <input type="radio" class="radio" name="Gender" value="1" id="gender_1" <%=UserInfo.Gender == 1 ? "checked='checked'":"" %>/>
				                        </td>
				                        <td>
				                            <label for="gender_1">남</label>
				                        </td>
				                        <td>
				                            <input type="radio" class="radio" name="Gender" value="2" id="gender_2" <%=UserInfo.Gender == 2 ? "checked='checked'":"" %>/>
				                        </td>
				                        <td>
				            ...
				            <td>
				                 <table>
                                    ...
                                    <% for (int i = 1940; i < DateTime.Now.Year + 3; i++){ %>
										<option value="<%=i %>" <%=i==UserInfo.Birthday.Year?"selected='selected'":"" %>><%=i %></option>
									<% } %>
                                            </select>년
                                        </td>
                                        <td>
                                     ...
                                     <%for ( int i = 1; i <= 12; i ++ ) { %>
										<option value="<%=i %>" <%=i==UserInfo.Birthday.Month?"selected='selected'":"" %>><%=i %></option> 
									 <% } %>
                                            </select>월
                                        </td>
                                        <td>
                                     ...
                                     <%for ( int i = 1; i <= 31; i ++ ) { %>
										<option value="<%=i %>" <%=i==UserInfo.Birthday.Day?"selected='selected'":"" %>><%=i %></option> 
									 <% } %>
				        ...
				        <tr>
				            ...
				            <td>				                
								<table>
									<tr>
										<td><input class="w2" name="UserID" type="text" value="<%=UserInfo.UserID %>" readonly/></td>
									</tr>
								</table>							
				            </td>
				        </tr>
				        ...
				        <tr>
				            ...
				            <td>
				                <table>
				                    <tr>
										<td><input class="w2" name="Email" type="text" value="<%=UserInfo.Email %>" maxlength="100"/></td>
				        ...
				        <tr>
				            ...
				            <td>
				                 <table>
				                    <tr>
				                        <td>한국</td>
										<td><input class="w2" name="KRPhoneNo" type="text" value="<%=UserInfo.KRPhoneNo %>"  maxlength="30"/></td>
										<td class="blank"></td>
										<td>중국</td>
										<td><input class="w2" name="CNPhoneNo" type="text" value="<%=UserInfo.CNPhoneNo %>"  maxlength="30"/></td>
				        ...
				        <tr>
				            ...
				            <td>
				                <table>
				                    <tr>
				                        <td>
				                            <input type="radio" class="radio" name="ResidanceCountry" value="1" id="national_1" <%=UserInfo.ResidanceCountry == 1 ? "checked='checked'":"" %>/>
				                        </td>
				                        <td>
				                            <label for="national_1">한국</label>
				                        </td>
				                        <td>
				                            <input type="radio" class="radio" name="ResidanceCountry" value="2" id="national_2" <%=UserInfo.ResidanceCountry == 2 ? "checked='checked'":"" %>/>
				                        </td>
				                        <td>
				        ...
				        <tr>
				            ...
				            <td>
				                <table>
				                    <tr>
										<td><input class="w2" name="HomepageUrl" type="input"  value="<%=UserInfo.HomepageUrl %>" maxlength="100"/></td>										
...
(function($){
    var UserID = "<%=this.WebCookies.UserID %>";
    var Email = "<%=this.WebCookies.Email %>";
    var isPrecess = false;
    $.extend({
        CreateInit:function()
        {
