...
{
    public class ArticleWritePage : SitePage
    {
        ...
        public List<BoardCategoryEntity> BoardCategoryList
        {
            get {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (ArticleNo == 0)
            {
                m_AricleInfo = new ArticleEntity();
            }
            else
            {
        ...
        public void SetArticleCreate(ArticleCreateArguments arg)
        {
            ArticleCreate create = new ArticleCreate();
