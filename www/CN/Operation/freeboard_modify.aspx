...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
                        ...
                        <div class="contents">
                            <table class="board-write">
                                <tr class="top">
                                    <td class="col1"><%= GetText("CN_Operation_freeboard_modify.aspx_14")%><span class="require">*</span></td>
                                    <td class="col2">
                                        <select name="BoardCategoryNo">
<% foreach (BoardCategoryEntity item in BoardCategoryList) { %>
                                            <option value="<%=item.BoardCategoryNo %>" <%=item.BoardCategoryNo == ArticleInfo.BoardCategoryNo ? "Selected='selected'" : "" %>><%=item.CategoryName%></option>
<% } %>
                                        </select>
                                    </td>
                                    <td class="col3"><%= GetText("CN_Operation_freeboard_modify.aspx_22")%><span class="require">*</span></td>
                                    <td class="col4">
                                        <input type="text" name="ArticleTitle" id="ArticleTitle" value="<%=ArticleInfo.ArticleTitle %>"/>
                                    </td>
                                </tr>
                                <tr class="middle">
                                    <td colspan="4">
                                            ...
                                            <div class="wyswig-tool">
                                                <div class="toolbox">
                                                    <select id="TEditor_fontSyle" class="font-type">
                                                        <option value="0"><%= GetText("CN_Operation_freeboard_modify.aspx_33")%></option>
                                                ...
                                                <div class="toolbox">
                                                    <select id="TEditor_fontSize" class="font-size">
                                                        <option value="0"><%= GetText("CN_Operation_freeboard_modify.aspx_42")%></option>
...
var TextEditor = new HyperTextArea("TEditor", "<%= ArticleInfo.ArticleContent.Replace( "\r\n", "" ).Replace("\"", "\\\"") %>" , 687, 285,"");
...
function onWrite()
{
    if ( $( "#ArticleTitle" ).val() == "" )
    {
        alert( $.translateHelper.getText("CN_Operation_freeboard_modify.aspx_114"));
        return false;
    }
    ...
    if ( TextEditor.html == "" )
    {
        alert( $.translateHelper.getText("CN_Operation_freeboard_modify.aspx_123") );
        return false;
    }
